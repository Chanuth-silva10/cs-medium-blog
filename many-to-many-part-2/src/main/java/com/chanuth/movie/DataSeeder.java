package com.chanuth.movie;

import com.chanuth.movie.entities.Movie;
import com.chanuth.movie.entities.User;
import com.chanuth.movie.entities.UserMovie;
import com.chanuth.movie.entities.UserMovie.UserMovieId;
import com.chanuth.movie.repositories.MovieRepository;
import com.chanuth.movie.repositories.UserMovieRepository;
import com.chanuth.movie.repositories.UserRepository;
...
public class DataSeeder implements ApplicationListener<ContextRefreshedEvent> {
  ...
  public void onApplicationEvent(ContextRefreshedEvent event) {
    ...
    Movie createdMovie2 = movieRepository.save(movie2);
      ...
      User user = new User("chanuth@gmail.com", "Chanuth Silva");
